<div id="agreement-ooo-print-{{contract.id}}" class="printable">
	...
	<p> <b>Общество с ограниченной ответственностью «ЕГЭ-ЦЕНТР»</b>, в лице Генерального директора Капралова Константина Александровича, действующего на основании Устава, именуемое в дальнейшем «Исполнитель», «ЕГЭ-Центр», на основании лицензии на осуществление образовательной деятельности № 037742, выданной Департаментом образования города Москвы 08.08.2016 г., с одной стороны, и {{contractPrintName(representative, 'nominative')}}, именуемый(ая) в дальнейшем «Заказчик», являющийся(щаяся) родителем (законным представителем) {{contractPrintName(representative, 'genitive')}}, {{student.Passport.date_birthday}} года рождения, именуемого(ой) в дальнейшем «Обучающийся», с другой стороны, совместно именуемые «Стороны», заключили настоящее Дополнительное соглашение (далее – «Договор») о нижеследующем:</p>
	...
	<p>- Пункт 3.1. Договора изложить в следующей редакции:<br>
		«Общая стоимость Услуг Исполнителя по Договору складывается из стоимости отдельных занятий, приобретаемых на момент заключения Договора, и составляет {{contract.sum | number}} (<span class="m_title">{{numToText(contract.sum)}}</span>)
