<div class="row" ng-show="student !== undefined">
    <div class="col-sm-12">
					...
					<td align="right" width="3%" class="no-padding-right">
						...
						<div ng-show="contract.show_actions" class="contex-menu fadeInUp fadeOutDown">
                            <ul>
								...
								<li class='link-like' ng-click="printActTerminationIp(contract)" ng-show='isLastContractInChain(contract)'>печать соглашения о расторжении ИП</li>
		...
		<?= partial("contract_termination_ip_print") ?>
    </div>
</div>
