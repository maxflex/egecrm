		    ...
		    <div class="row">
						...
						<div class="form-group" ng-show="student_phone_level >= 2">
							<div class="input-group"
								...
								<div class="input-group-btn">
									...
									<button class="btn btn-default" type="button"
											ng-show="PhoneService.isFull(student.phone2) && PhoneService.isMobile(student.phone2)"
											ng-class="{'addon-bordered' : student_phone_level >= 3 || !PhoneService.isFull(student.phone2)}"
			    ...
			    <div class="col-sm-3">
					...
					<div>
						<div class="form-group">
							<div class="input-group"
								 ng-class="{'input-group-with-hidden-span' : !PhoneService.isFull(representative.phone)  || (!PhoneSerice.isMobilePhone(representative.phone) && representative_phone_level >= 2)  }">
								<input id="representative-phone" type="text" placeholder="телефон" class="form-control phone-masked"  name="Representative[phone]"
									   ng-model="representative.phone"
									   ng-value="PhoneService.format(representative.phone)"
								>
								<div class="input-group-btn">
									<button class="btn btn-default"
											ng-show="PhoneService.isFull(representative.phone) && PhoneService.isMobile(representative.phone)"
											ng-click="PhoneService.call(representative.phone)"
									>
										<span class="glyphicon glyphicon-earphone no-margin-right small"></span>
									</button>
									<button class="btn btn-default" type="button"
											ng-show="PhoneService.isFull(representative.phone) && PhoneService.isMobile(representative.phone)"
											ng-class="{'addon-bordered' : representative_phone_level >= 2 || !PhoneService.isFull(representative.phone)}"
											ng-click="PhoneService.sms(representative.phone)"
									>
										<span class="glyphicon glyphicon-envelope no-margin-right small"></span>
									</button>
									<button class="btn btn-default" type="button"
											ng-hide="representative_phone_level >= 2 || !PhoneService.isFull(representative.phone)"
											ng-click="representative_phone_level = representative_phone_level + 1"
									>
										<span class="glyphicon glyphicon-plus no-margin-right small"></span>
									</button>
								</div>
						...
						<div class="form-group" ng-show="representative_phone_level >= 2">
							<div class="input-group"
								 ng-class="{'input-group-with-hidden-span' : !PhoneService.isFull(representative.phone2)  || (!PhoneService.isMobile(representative.phone2) && representative_phone_level >= 3)  }">
								<input id="representative-phone-2" type="text" placeholder="телефон 2" class="form-control phone-masked"  name="Representative[phone2]"
									   ng-model="representative.phone2"
									   ng-value="PhoneService.format(representative.phone2)"
								>
								<div class="input-group-btn">
									<button class="btn btn-default"
											ng-show="PhoneService.isFull(representative.phone2) && PhoneService.isMobile(representative.phone2)"
											ng-click="PhoneService.call(representative.phone2)">
										<span class="glyphicon glyphicon-earphone no-margin-right small"></span>
									</button>
									<button class="btn btn-default" type="button"
											ng-show="PhoneService.isFull(representative.phone2) && PhoneService.isMobile(representative.phone2)"
									...
									<button class="btn btn-default" type="button"
											ng-hide="representative_phone_level >= 3 || !PhoneService.isFull(representative.phone2)"
											ng-click="representative_phone_level = representative_phone_level + 1"
									>
										<span class="glyphicon glyphicon-plus no-margin-right small"></span>
									</button>
						...
						<div class="form-group" ng-show="representative_phone_level >= 3">
							<div class="input-group"
								 ng-class="{'input-group-with-hidden-span' : !PhoneService.isFull(representative.phone3)  || !PhoneService.isMobile(representative.phone3) }">
								<input type="text" id="representative-phone-3" placeholder="телефон 3" class="form-control phone-masked"  name="Representative[phone3]"
									   ng-model="representative.phone3"
									   ng-value="PhoneService.format(representative.phone3)"
								>
								<div class="input-group-btn">
									<button class="btn btn-default"
											ng-show="PhoneService.isFull(representative.phone3) && PhoneService.isMobile(representative.phone3)"
									...
									<button class="btn btn-default" type="button"
											ng-show="PhoneService.isFull(representative.phone3) && PhoneService.isMobile(representative.phone3)"
											ng-class="{'addon-bordered': !PhoneService.isFull(representative.phone3)}"
											ng-click="PhoneService.sms(representative.phone3)"
									>
										<span class="glyphicon glyphicon-envelope no-margin-right small"></span>
									</button>
								</div>
