...
-->
		<td width="15%">
			<span ng-show="Group.first_lesson_date">
				<span ng-show="!Group.lesson_count.conducted">1-й урок {{Group.first_lesson_date | date:"dd.MM"}} ({{ Group.lesson_count.all }} <ng-pluralize count="Group.lesson_count.all" when="{
					'one': 'урок',
					'few': 'урока',
					'many': 'уроков'
				}"></ng-pluralize>)</span>
