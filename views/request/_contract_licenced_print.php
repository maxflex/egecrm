...
<p><b>2.1. Исполнитель обязуется:</b></p>
	<p>2.1.1. Предоставить Заказчику и Обучающемуся доступ к личному кабинету. Данные для доступа в личный кабинет представителя:</p>
	<ul style="margin: 0">
        <li>Адрес: https://lk.ege-centr.ru</li>
        <li>Логин: email представителя, указанный при заключении договора ({{ representative.email || 'email отсутствует' }})</li>
        <li>Пароль: назначается Заказчиком (представителем) самостоятельно при первом входе в личный кабинет</li>
    </ul>
	<p>Данные для доступа в личный кабинет ученика:</p>
	<ul style="margin: 0">
		<li>Адрес: https://lk.ege-centr.ru</li>
        <li>Логин: email ученика, указанный при заключении договора ({{ student.email || 'email отсутствует' }})</li>
