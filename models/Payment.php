...
//			self::NOT_PAID_BILL,
		...
		public function beforeSave()
        {
            ...
            if (($this->id_status == self::PAID_CASH) && ($this->id_type == PaymentTypes::PAYMENT) && !$this->document_number && $this->entity_type == Student::USER_TYPE) {
...
//                $this->update(['document_number' => $this->document_number]);
                ...
                //удаление номера если он есть, но условия неверны
