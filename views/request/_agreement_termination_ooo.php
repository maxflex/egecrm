<div id="termination-ooo-print" class="printable">
    <div style="margin-left: 1cm;">
        ...
        <p class="no-ident">
            ...
            именуемого(ой) в дальнейшем «Обучающийся», с другой стороны, совместно именуемые «Стороны», подписали настоящее соглашение о нижеследующем:
        <ol>
            <li>
            ...
            <li>
                Настоящее соглашение составлено в двух экземплярах, по одному для каждой из Сторон, и является неотъемлемой частью Договора.
            </li>
        </ol>
        </p>
