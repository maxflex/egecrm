...
<p><b>2.1. Исполнитель обязуется:</b></p>
	<p>2.1.1. Предоставить Заказчику и Обучающемуся доступ к личному кабинету. Данные для доступа в личный кабинет создаются Заказчиком и Обучающимся самостоятельно и известны только пользователю.</p>
