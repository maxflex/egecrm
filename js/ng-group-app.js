...
(function() {
  ...
  angular.module("Group", ['ngAnimate']).filter('to_trusted', [
    '$sce', function($sce) {
    ...
    $(document).ready(function() {
      ...
      return $("#group-cabinet").selectpicker();
    });
    justSave = function() {
    ...
    $scope.groupsFilter = function(Group) {
      ...
      return time_correct && (Group.grade === parseInt($scope.search.grade) || !$scope.search.grade) && (parseInt($scope.search.id_branch) === Group.id_branch || !$scope.search.id_branch) && ($scope.search.subjects.length === 0 || (ref = Group.id_subject.toString(), indexOf.call($scope.search.subjects, ref) >= 0)) && (parseInt($scope.search.id_teacher) === parseInt(Group.id_teacher) || !$scope.search.id_teacher) && (parseInt($scope.search.cabinet) === parseInt(Group.cabinet) || !parseInt($scope.search.cabinet));
    };
