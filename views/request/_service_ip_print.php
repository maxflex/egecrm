<div id="service-act-ip-print" class="printable">
    ...
    <table class="p-table">
        ...
        <tr class="full-border">
            <td>1</td>
            <td class="left">Агентские услуги согласно договору №{{ service_contract_parent.id }} от {{ service_contract_parent.date }}г.</td>
            <td>1</td>
            <td>услуга</td>
            <td>{{ service_contract_parent.sum }}</td>
            <td>{{ service_contract_parent.sum }}</td>
        </tr>
    ...
    <div style='margin: 10px 0 0'>
        <div style="display: inline-block; width: 50%">
            <div style='display: inline-block;'>
                <div style="border-bottom: 1px solid black">
                    <span style="color:white">__________________________</span> {{ representative.last_name }} {{ representative.first_name[0] }}. {{ representative.middle_name[0] }}.
                </div>
                <div class="sign-hint">
        ...
        <div style="display: inline-block; width: 50%">
            <div style='display: inline-block;'>
                <div style="border-bottom: 1px solid black">
                    <span style="color:white">__________________________</span> ИП Капралов К. А.
                </div>
                <div class="sign-hint">
                    (наименование организации)
                </div>
