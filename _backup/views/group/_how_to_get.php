<?php if (file_exists("img/maps/branch_address/" . $Group->id_branch . ".jpg")) :?>
		...
		<div class="row">
			<div class="col-sm-9" style="max-width: 830px">
				<div class="alert alert-danger" style="text-align: center">
					<span style="font-size: 21px; font-weight: bold">Распечатайте эту информацию перед первым занятием. Чтобы найти центр и кабинет в первый раз прийдите за 40 минут до начала занятия</span>
				</div>
