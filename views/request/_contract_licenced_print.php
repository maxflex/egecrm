<div id="contract-licenced-print-{{contract.id}}" class="printable printable-contract">
	...
	<p><b>Общество с ограниченной ответственностью «ЕГЭ-ЦЕНТР»</b>, в лице Генерального директора Капралова К.А., действующего на основании Устава, именуемое в дальнейшем «Исполнитель», «ЕГЭ-Центр», на основании лицензии на осуществление образовательной деятельности №_______________, выданной Департаментом образования города Москвы с одной стороны, и 
{{contractPrintName(representative, 'instrumental')}}, именуемый в дальнейшем «Заказчик», являющийся родителем (законным представителем) {{contractPrintName(student, 'genitive')}}, {{ student.Passport.date_birthday.slice(-4) }} года рождения, именуемого(ой) в дальнейшем «Обучающийся», с другой стороны, совместно именуемые «Стороны», заключили настоящий Договор на оказание платных образовательных услуг (далее – «Договор») о нижеследующем:</p>
<h4>1. Предмет Договора.</h4>
<p>1.1. По настоящему Договору Исполнитель обязуется зачислить Обучающегося на обучение и оказать Обучающемуся образовательные услуги по программе дополнительного обучения по курсу (курсам): «<span ng-repeat="subject in contract.subjects">{{SubjectsFull[subject.id_subject]}}{{!$last ? ", " : ""}}</span>» (далее – «Услуги»), а Заказчик обязуется оплатить указанные Услуги в порядке и на условиях, которые установлены настоящим Договором.</p>
<p>1.2. Обучение осуществляется в порядке, установленном локальными нормативными актами Исполнителя и настоящим Договором.</p>
<p>1.3. Продолжительность образовательной программы по программе курса «_____________________»: ____ часов. Форма обучения – очная. </p>
<p>1.4. Место оказания Услуг по Договору: _____________________________________________________.</p>
<p>1.5. Вид образования: дополнительное образование детей и взрослых, продолжительность обучения: ____________. </p>

<h4>2. Права и обязанности Сторон.</h4>

<p><b>2.1. Исполнитель обязуется:</b></p>
<p>2.1.1. Выполнять принятые на себя обязательства по оказанию Услуг Обучающемуся качественно и в сроки, согласованные с Заказчиком в соответствии с требованиями, изложенными в настоящем Договоре и дополнительных соглашениях к нему. </p>
<p>2.1.2. Зачислить Обучающегося на обучение после оплаты Заказчиком стоимости услуг Исполнителя и представления следующих документов:</p>
    <ul style="margin: 0">
        ...
        <li><span style='color: red'>Фото в формате jpeg.</span></li>
    </ul>
<p>2.1.3. Создать Обучающемуся необходимые условия для освоения выбранной образовательной программы, а именно, предоставить каждому Обучающемуся учебное посадочное место размером не менее 70 см. в каждом помещении (классе), где проводятся занятия, обеспечить наличие досок, проекторов по требованию преподавателя в части учебных классах, ноутбуков с необходимым для обучения программным обеспечением в классе информатики.</p>
<p>2.1.4. Размещать расписание занятий (с точным указанием времени) не позднее, чем за 1 день до начала обучения на стенде Исполнителя в коридоре по месту оказания услуг, а также в личном кабинете Обучающегося.</p>
<p>2.1.5. Обеспечивать контроль знаний Обучающегося в порядке, предусмотренном  программой обучения. </p>
<p>2.1.6. Предоставить возможность Заказчику, в том числе до момента зачисления, ознакомиться с локальными актами ЕГЭ-Центра, а также информацией и документами ЕГЭ-Центра согласно указаниям Закона «Об Образовании в РФ».</p>
<p>2.1.7. Обеспечивать охрану жизни и безопасность здоровья, создавать безопасные условия обучения и содержания Обучающегося в ЕГЭ-Центре в соответствии с установленными нормами, обеспечивающими его жизнь и здоровье.</p>
<p>2.1.8. Предоставить Заказчику и Обучающемуся доступ к личному кабинету. Логин для доступа в личный кабинет <?= $Request->Student->login ?>, пароль <?= $Request->Student->password ?>. Указанные данные известны только сторонам договора. </p>
...
<p>2.4.2. При заключении настоящего Договора предоставить Исполнителю оригиналы или надлежащим образом заверенные копии документов, перечисленных в п. 2.1.2. Договора. </p>
...
<p>3.2. Стоимость занятий с 1 по 64 составляет 1500 (одна тысяча пятьсот) рублей за одно занятие, стоимость занятий с 65 по 96 составляет 1400 (одна тысяча четыреста) рублей за одно занятия, стоимость занятий с 97 и всех последующих составляет 1300 (одна тысяча триста) рублей.</p>
...
- 50 % суммы, указанной в п.3.1. вносится в момент заключения Договора;</p>
- оставшиеся 50  % суммы, указанной в п.3.1. вносятся до 15 января 2017 года .</p>
В случае нарушения Заказчиком обязанностей по оплате услуг Исполнителя, согласованных в графике платежей, Исполнитель вправе применить согласованные Сторонами в Договоре меры ответственности за просрочку оплаты. </p>
...
<p>4.3.2. Заказчик дает согласие на видео и фотосъемку Обучающегося, организуемую Исполнителем в процессе обучения. Видео и фотосъемка производятся во время одного из занятий. Видео и фотосъемка могут продолжаться в течение не более чем одного академического часа. </p>
...
<h4>6. Порядок расторжения Договора.</h4>
...
Если Исполнитель отказывается от исполнения Договора, то он возвращает Заказчику все полученные от него в порядке предварительной оплаты на основании соответствующей заявки на обучение денежные средства, за исключением стоимости фактически оказанных услуг. </p>
Если Заказчик отказывается от исполнения Договора, то он оплачивает оказанные услуги (проведенные занятия) и фактически понесенные расходы Исполнителя (сумма, пропорциональная объему образовательной программы, который был надлежащим образом обеспечен Исполнителем к моменту отказа от договора). </p>
Односторонний отказ от исполнения Договора любой из Сторон по основаниям, указанным в настоящем Договоре, влечет за собой его прекращение во внесудебном порядке. </p>
...
при систематическом нарушении дисциплины (более 1 раза в течение календарного месяца);</p>
при действиях со стороны Обучающегося, в результате которых создается угроза для физического и психологического здоровья и благополучия остальных Обучающихся, педагогов и иных работников Исполнителя;</p>
при действиях со стороны Обучающегося, в результате которых создаются препятствия для образовательного процесса, в т.ч. для остальных обучающихся;</p>
при демонстративном общем неуважении к окружающим, проявлении расизма и национализма, склонности к созданию агрессивных группировок;</p>
вследствие состояния здоровья Обучающегося, не позволяющего ему систематически посещать занятия; </p>
при грубом нарушении локальных актов Исполнителя, которые распространяются на Обучающегося и на Заказчика и с которыми последний был ознакомлен;</p>
установления нарушения порядка приема в образовательную организацию, повлекшего по вине Заказчика незаконное зачисление Обучающегося в группу обучения.</p>
...
Стороны будут прилагать все усилия к тому, чтобы решать возникающие разногласия и путем переговоров. В случае возникновения разногласий и споров, связанных с исполнением настоящего Договора, Стороны принимают усилия по их урегулированию путем переговоров. Все претензии подаются только в письменной форме и должны быть рассмотрены в течение 30 (тридцати) дней. Если Стороны не достигнут компромисса, спор подлежит разрешению в судебном порядке в соответствии с правилами процессуального законодательства РФ.</p>
</p>
