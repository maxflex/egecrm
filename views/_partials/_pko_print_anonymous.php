        ...
        <tr>
            <td width="55%" style="padding:5px;">
                <table width="100%" style="vertical-align: top">
                    ...
                    <tr>
                        <td>
	                        Принято от: {{PrintPayment.extra.last_name }} {{PrintPayment.extra.first_name }} {{PrintPayment.extra.middle_name }}
	                    </td>
                    </tr>

                    <tr><td style="padding:10px;"></td></tr>

                    <tr><td>Основание: <br>Публичная оферта на проведение {{ PrintPayment.category == 2 ? 'профориентации' : 'пробного ЕГЭ' }}</tr></td>
            ...
            <td width="45%" style="padding:5px;vertical-align: top;border-left: 2px dotted black;">
                <table>
                    ...
                    <tr><td align="right" width="40%">от </td><td align="left" style="border-bottom: 1px solid black"><b>{{ formatPkoDate(PrintPayment.date) }}</b></td></tr>

                    <tr style="padding:10px;"><td colspan="2"></td></tr>
                    <tr><td colspan="2">
	                    <div style="height: 39px !important">
	                   		Принято от <br>{{PrintPayment.extra.last_name}} {{PrintPayment.extra.first_name}} {{PrintPayment.extra.middle_name}}
	                    </div>
	                </td></tr>
                    ...
                    <tr><td colspan="2">
	                    ...
	                    Основание <br>Публичная оферта на проведение {{ PrintPayment.category == 2 ? 'профориентации' : 'пробного ЕГЭ' }}
	                    </div>
	                 </td></tr>
                    ...
                    <tr>
                        <td width="30%"></td>
                        <td style="border-bottom: 1px solid black;"><b>{{ formatPkoDate(PrintPayment.date) }}</b></td>
                    </tr>
                    <tr>
