	...
	<div class="panel-body">
		...
		<div class="row mb">
			...
			<div class="col-sm-6">
				...
				<div class="from-them">
					Например: Алексей работает активно. Даже иногда слишком активно, что раньше мешало остальным ученикам в группе, но сейчас этого не происходит. Хорошо усваивает материал на уроках.
				</div>
			</div>
		</div>
		...
		<div class="row mb">
			<div class="col-sm-12">
				...
				<div class="row">
					<div class="col-sm-3">
						<input class="form-control bs-date-top" placeholder="дата отчета" ng-model="Report.date">
					</div>
<!--
					<div class="col-sm-9">
