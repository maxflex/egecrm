...
angular.module("Group", ['ngAnimate', 'chart.js']).filter('toArray', function() {
  ...
  $scope.dayAndTimeObject = function() {
    var day_and_time;
    day_and_time = {};
    $.each($scope.Group.day_and_time, function(day, value) {
      if (value === void 0) {
        return;
      }
      return $.each(value, function(index, time) {
        if (time) {
          if (day_and_time[day] === void 0) {
            day_and_time[day] = {};
          }
          return day_and_time[day][index] = time;
        }
      });
    });
    return day_and_time;
  ...
  $scope.hasDayAndTime = function() {
    ...
    return Object.keys($scope.day_and_time_object).length > 0;
  };
