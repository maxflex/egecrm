...
<div id="contract-print-{{contract.id}}" class="printable">
	...
	<p style="margin-bottom: 20px"><b>Консультируемый: {{student.last_name}} {{student.first_name}} {{student.middle_name}}</b>, паспорт серия: {{student.Passport.series}} № {{student.Passport.number}}{{student.phone ? ", телефон: " + student.phone : ""}}{{student.phone2 ? ", " + student.phone2 : ""}}{{student.phone3 ? ", " + student.phone3 : ""}}{{student.email ? ", email: " + student.email : ""}}
	</p>
	
	<p style="margin-bottom: 20px"><b>Агент</b> _________________ {{users[id_user_print].last_name}} {{users[id_user_print].first_name[0]}}. {{users[id_user_print].middle_name[0]}}.</p>
