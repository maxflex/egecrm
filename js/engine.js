	...
	var review_statuses_approved = ['не подтверждено', 'подтверждено']
...
С уважением, {user_first_last}, ответственный по тестированию (ЕГЭ-Центр-Москва), +7 (495) 646-85-92"
	...
	var sotN_ru=new Array("сто","двести","триста","четыреста","пятьсот","шестьсот","семьсот","восемьсот","девятьсот");
