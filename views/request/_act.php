      ...
      <table class="invoice_items" width="100%" cellpadding="2" cellspacing="2" style="margin-top: 15px">
            ...
            <tbody>
                <tr>
                    ...
                    <td align="left" style="font-size: 12px">Агентские услуги согласно договору №{{contract.id}} от {{getFirstVersionDate(contract)}}г.</td>
