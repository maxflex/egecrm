<!-- ЛАЙТБОКС РЕДАКТИРОВАНИЕ ПЕЧАТИ ДОГОВОРА ВРУЧНУЮ -->
	...
	<div class="lightbox-new lightbox-addpayment">
		...
		<span class="small" ng-show="new_payment.id_status == <?= Payment::PAID_CASH ?> && new_payment.id_type == 1">({{ new_payment.document_number ? 'ПКО присвоен порядковый номер ' + new_payment.document_number : 'будет присвоен порядковый номер ПКО' }})</span>
